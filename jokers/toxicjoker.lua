...
SMODS.Joker{ --Toxic Joker
    ...
    config = {
        extra = {
            pb_h_mult_f1bc673a = 2
        }
    },
    loc_txt = {
        ['name'] = 'Toxic Joker',
        ['text'] = {
            [1] = '{C:attention}Scored{} cards permanently',
            [2] = 'gain {C:red}+2{} Mult that is given',
    ...
    calculate = function(self, card, context)
        if context.individual and context.cardarea == G.play  then
            ...
            context.other_card.ability.perma_h_mult = context.other_card.ability.perma_h_mult + 2
            return {
