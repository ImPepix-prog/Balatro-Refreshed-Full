...
if true then
    ...
    assert(SMODS.load_file("jokers/calcetinconrombosman.lua"))()
    assert(SMODS.load_file("jokers/smotsgaming.lua"))()
    assert(SMODS.load_file("jokers/mratillo2001.lua"))()
    assert(SMODS.load_file("jokers/perseverantjoker.lua"))()
    assert(SMODS.load_file("jokers/kindjoker.lua"))()
    assert(SMODS.load_file("jokers/integraljoker.lua"))()
    assert(SMODS.load_file("jokers/bravejoker.lua"))()
    assert(SMODS.load_file("jokers/patientjoker.lua"))()
    assert(SMODS.load_file("jokers/justicejoker.lua"))()
    assert(SMODS.load_file("jokers/pepix.lua"))()
...
if true then
    ...
    assert(SMODS.load_file("decks/arcana_deck.lua"))()
    assert(SMODS.load_file("decks/celestial_deck.lua"))()
    assert(SMODS.load_file("decks/that_one_deck_everyone_hates_playing_with.lua"))()
    assert(SMODS.load_file("decks/white_deck.lua"))()
end
...
SMODS.ObjectType({
    ...
    cards = {
        ...
        ["j_Refreshed_calcetinconrombosman"] = true,
        ["j_Refreshed_smotsgaming"] = true,
        ["j_Refreshed_mratillo2001"] = true,
        ["j_Refreshed_perseverantjoker"] = true,
        ["j_Refreshed_kindjoker"] = true,
        ["j_Refreshed_integraljoker"] = true,
        ["j_Refreshed_bravejoker"] = true,
        ["j_Refreshed_patientjoker"] = true,
        ["j_Refreshed_justicejoker"] = true,
        ["j_Refreshed_pepix"] = true,
