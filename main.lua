...
if true then
    ...
    assert(SMODS.load_file("consumables/rthedevil.lua"))()
    assert(SMODS.load_file("consumables/rtemperance.lua"))()
    assert(SMODS.load_file("consumables/rdeath.lua"))()
    assert(SMODS.load_file("consumables/rhangedman.lua"))()
    assert(SMODS.load_file("consumables/rstrenght.lua"))()
    assert(SMODS.load_file("consumables/rwheeloffortune.lua"))()
    assert(SMODS.load_file("consumables/rhermit.lua"))()
    ...
    assert(SMODS.load_file("consumables/rtheemperor.lua"))()
    assert(SMODS.load_file("consumables/theempress.lua"))()
    assert(SMODS.load_file("consumables/thehighpriestess.lua"))()
    assert(SMODS.load_file("consumables/themagician.lua"))()
    assert(SMODS.load_file("consumables/thefool.lua"))()
end
--load the sets
